...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void setAtSign() async {
    _atsign = await _atClientService.getAtSign();
  }
  ...
  _scan() async {
    List<AtKey> response = await _atClientService.getAtKeys(sharedBy: _atsign);
  ...
  _lookup() async {
    print("Retrieved key: " + _lookupKey);
    if (_lookupKey != null) {
      AtKey lookup = AtKey();
      lookup.key = _lookupKey;
      lookup.sharedWith = _atsign;
