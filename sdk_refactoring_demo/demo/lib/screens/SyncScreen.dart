...
class _SyncScreenState extends State<SyncScreen> {
  ...
  Future<void> onSyncComplete(SyncManager manager) async {
    ...
    commitIdAfterSync = (await SyncUtil.getLastSyncedEntry(null,
            atSign: _serverDemoService.atSign))
        ?.commitId
        ?.toString();
  ...
  _sync() async {
    ...
    commitIdBeforeSync = (await SyncUtil.getLastSyncedEntry(null,
            atSign: _serverDemoService.atSign))
        ?.commitId
        ?.toString();
    setState(() {
  ...
  _syncOnce() async {
    ...
    await _serverDemoService.syncOnce(onSyncComplete, onSyncException);
  }
}
